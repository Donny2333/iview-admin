    ...
    function (document, DomQuery, Class, EventDispatcher, Tools, BoxUtils, ClassList, Collection, ObservableObject, DomUtils, ReflowQueue) {
      ...
      function bindPendingEvents (eventCtrl) {
        ...
        function mouseEnterHandler (e) {
          var ctrl = eventCtrl.getParentCtrl(e.target), lastCtrl = eventRootCtrl._lastHoverCtrl, idx = 0, i, parents,
            lastParents
 ...
 * }).renderTo(document.body);
     ...
     */
      ...
      var is = function (element, selector) {
        ...
        if (elem.nodeType !== ELEMENT) {
          return false
        }// documents have querySelector but not matches

        // As of Chrome 34 / Safari 7.1 / FireFox 34, everyone except IE has the unprefixed function.
        // Still check for the others, but do it last.
        else if (selectorType === STANDARD) {
          return elem.matches(selector)
        } else if (selectorType === MSSTANDARD) {
          return elem.msMatchesSelector(selector)
        } else if (selectorType === WEBKITSTANDARD) {
          return elem.webkitMatchesSelector(selector)
        } else if (selectorType === FIREFOXSTANDARD) {
  ...
  define(
    ...
    function (Fun, Element, SelectorFind, document, EditorManager, Env, Control, FloatPanel, Widget, Align, FontSelect, FontSizeSelect, FormatSelect, Formats, InsertButton,
      ...
      return AbsoluteLayout.extend({
        ...
        recalc: function (container) {
          var settings, rows, cols, items, contLayoutRect, width, height, rect,
            ...
            alignV, maxX, maxY,
            colWidths = [], rowHeights = [], ctrlMinWidth, ctrlMinHeight, availableWidth, availableHeight, reverseRows,
            idx
  ...
  define(
    ...
    function (Factory, Tools, AbsoluteLayout, BrowseButton, Button, ButtonGroup, Checkbox, Collection, ColorBox, ColorButton, ColorPicker, ComboBox, Container, Control,
